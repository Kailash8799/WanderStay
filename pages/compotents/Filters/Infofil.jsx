...
const Infofil = ({
  ...
  return (
    <div>
      ...
      <div className="h-[32vh] mx-2  space-y-8 mt-2  scroll-smooth no-scrollbar">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center justify-between space-x-2">
            <AiOutlineMinusCircle
              onClick={() => {
                settotalguest(totalguests == 0 ? 0 : totalguests - 1);
              }}
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center justify-between space-x-2">
            <AiOutlineMinusCircle
              onClick={() => {
                settotalroom(totalrooms == 0 ? 0 : totalrooms - 1);
              }}
              className="cursor-pointer"
              size={25}
            />
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center justify-between space-x-2">
            <AiOutlineMinusCircle
              onClick={() => {
                settotalbathrooms(totalbathrooms == 0 ? 0 : totalbathrooms - 1);
              }}
              className="cursor-pointer"
              size={25}
            />
            ...
            <AiOutlinePlusCircle
              onClick={() => {
                settotalbathrooms(totalbathrooms + 1);
              }}
              className="cursor-pointer"
              size={25}
            />
